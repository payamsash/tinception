...
"""
This script performs normative modeling at voxel level.

- Prepares covariates and response variables from VBM and ROI datasets.
- Constructs normative models using PCNToolkit's BLR framework with B-spline basis functions.
- Fits models on control subjects and predicts deviations for test or all subjects.
- Supports multiple atlases (Amygdala, Hippocampus, Thalamus) and harmonizes region names.
- Saves fitted models, extended predictions, and normative outputs for downstream analyses.
"""
